...
// node_modules/.pnpm/@opennextjs+cloudflare@1.19.10_next@16.2.6_@babel+core@7.29.0_react-dom@19.2.4_react@19_ca4096472dbcff61d91c79ce529cee62/node_modules/@opennextjs/cloudflare/dist/api/durable-objects/queue.js
...
var DOQueueHandler = class extends DurableObject {
    ...
    try {
      ...
      response = await this.service.fetch(`${protocol}://${host}${url}`, {
        ...
        headers: {
          ...
          "x-prerender-revalidate": "80d056d9f7c32892b59461cb1a97d554",
          "x-isr": "1"
        },
  ...
  async addToFailedState(msg) {
    ...
    if (!this.disableSQLite) {
      this.sql.exec("INSERT OR REPLACE INTO failed_state (id, data, buildId) VALUES (?, ?, ?)", msg.MessageDeduplicationId, JSON.stringify(updatedFailedState), "3emXEDl4J6v1o0PgnVJV4");
    }
    await this.addAlarm();
  }
  async addAlarm() {
  ...
  async initState() {
    ...
    this.sql.exec("DELETE FROM failed_state WHERE buildId != ?", "3emXEDl4J6v1o0PgnVJV4");
    this.sql.exec("DELETE FROM sync WHERE buildId != ?", "3emXEDl4J6v1o0PgnVJV4");
